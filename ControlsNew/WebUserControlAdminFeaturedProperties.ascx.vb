...
Partial Class WebUserControlAdminFeaturedProperties
    ...
    Private Sub UpdateForm()
        ...
        ButtonAdd.Enabled = (ListBoxSelectedProperties.Items.Count < 51) And (Not ListBoxAvailableProperties.SelectedItem Is Nothing)
        ...
        ' Set Warnings
        If ListBoxSelectedProperties.Items.Count < 51 Then
