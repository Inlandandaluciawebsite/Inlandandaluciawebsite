...
Partial Class WebUserControlAdminClientTour
    ...
    Private Sub UpdatePropertyDetails(ByVal nPropertyID As Integer, ByRef lblpatner As Label, ByRef lblName As Label, ByRef lblAddress As Label, ByRef lblTown As Label, ByRef lblContactNo As Label, ByRef lblPrice As Label, ByRef ddlHour As DropDownList, ByRef lblSeparator As Label, ByRef ddlMinute As DropDownList, ByRef lblKey As Label)
        ...
        If dtDataTable.Rows.Count > 0 Then
            ...
            ' Populate Form
            lblpatner.Text = dtDataTable.Rows(0).Item("Reference")
    ...
    Private Sub ProcessPropertySelection(ByRef ddl As DropDownList,
        ...
        Else
            ...
            If ddl.SelectedIndex > 0 Then
                ...
                UpdatePropertyDetails(Convert.ToInt32(ddl.SelectedValue), lblpatner, lblName, lblAddress, lblTown, lblContactNo, lblPrice, ddlTimeHour, lblTimeSeparator, ddlTimeMinute, lblKey)
