...
Partial Class WebUserControlAdminClientTourPrint
    ...
    Private Sub UpdatePropertyDetails(ByVal nPropertyID As Integer, ByRef lblName As Label, ByRef lblAddress As Label, ByRef lblTown As Label, ByRef lblContactNo As Label, ByRef lblPrice As Label, ByRef lblHour As Label, ByRef lblSeparator As Label, ByRef lblMinute As Label, ByRef lblKey As Label, ByRef lblGPS_latitude As Label, ByRef lblGPS_longitude As Label)
        ...
        If dtDataTable.Rows.Count > 0 Then
            ...
            lblGPS_latitude.Text = dtDataTable.Rows(0).Item("GPS_Latitude")
            lblGPS_longitude.Text = dtDataTable.Rows(0).Item("GPS_Longitude")
        End If
    ...
    Public Sub LoadTour()
        ...
        For Each CClientTourProperty As ClassClientTourProperty In CClientTour.TourProperty
            ...
            Select Case nPropertyCounter
                ...
                Case 1
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName1, LabelAddress1, LabelTown1, LabelContactNo1, LabelPrice1, LabelTimeHour1, LabelTimeSeparator1, LabelTimeMinute1, LabelKey1, LabelGPS_latitude1, LabelGPS_longitude1)
                    LoadPropertyViewing(CClientTourProperty, LabelReference1, LabelTimeHour1, LabelTimeMinute1)
                    TableRowProperty1.Visible = True

                Case 2
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName2, LabelAddress2, LabelTown2, LabelContactNo2, LabelPrice2, LabelTimeHour2, LabelTimeSeparator2, LabelTimeMinute2, LabelKey2, LabelGPS_latitude2, LabelGPS_longitude2)
                    LoadPropertyViewing(CClientTourProperty, LabelReference2, LabelTimeHour2, LabelTimeMinute2)
                    TableRowProperty2.Visible = True

                Case 3
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName3, LabelAddress3, LabelTown3, LabelContactNo3, LabelPrice3, LabelTimeHour3, LabelTimeSeparator3, LabelTimeMinute3, LabelKey3, LabelGPS_latitude3, LabelGPS_longitude3)
                    LoadPropertyViewing(CClientTourProperty, LabelReference3, LabelTimeHour3, LabelTimeMinute3)
                    TableRowProperty3.Visible = True

                Case 4
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName4, LabelAddress4, LabelTown4, LabelContactNo4, LabelPrice4, LabelTimeHour4, LabelTimeSeparator4, LabelTimeMinute4, LabelKey4, LabelGPS_latitude4, LabelGPS_longitude4)
                    LoadPropertyViewing(CClientTourProperty, LabelReference4, LabelTimeHour4, LabelTimeMinute4)
                    TableRowProperty4.Visible = True

                Case 5
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName5, LabelAddress5, LabelTown5, LabelContactNo5, LabelPrice5, LabelTimeHour5, LabelTimeSeparator5, LabelTimeMinute5, LabelKey5, LabelGPS_latitude5, LabelGPS_longitude5)
                    LoadPropertyViewing(CClientTourProperty, LabelReference5, LabelTimeHour5, LabelTimeMinute5)
                    TableRowProperty5.Visible = True

                Case 6
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName6, LabelAddress6, LabelTown6, LabelContactNo6, LabelPrice6, LabelTimeHour6, LabelTimeSeparator6, LabelTimeMinute6, LabelKey6, LabelGPS_latitude6, LabelGPS_longitude6)
                    LoadPropertyViewing(CClientTourProperty, LabelReference6, LabelTimeHour6, LabelTimeMinute6)
                    TableRowProperty6.Visible = True

                Case 7
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName7, LabelAddress7, LabelTown7, LabelContactNo7, LabelPrice7, LabelTimeHour7, LabelTimeSeparator7, LabelTimeMinute7, LabelKey7, LabelGPS_latitude7, LabelGPS_longitude7)
                    LoadPropertyViewing(CClientTourProperty, LabelReference7, LabelTimeHour7, LabelTimeMinute7)
                    TableRowProperty7.Visible = True

                Case 8
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName8, LabelAddress8, LabelTown8, LabelContactNo8, LabelPrice8, LabelTimeHour8, LabelTimeSeparator8, LabelTimeMinute8, LabelKey8, LabelGPS_latitude8, LabelGPS_longitude8)
                    LoadPropertyViewing(CClientTourProperty, LabelReference8, LabelTimeHour8, LabelTimeMinute8)
                    TableRowProperty8.Visible = True

                Case 9
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName9, LabelAddress9, LabelTown9, LabelContactNo9, LabelPrice9, LabelTimeHour9, LabelTimeSeparator9, LabelTimeMinute9, LabelKey9, LabelGPS_latitude9, LabelGPS_longitude9)
                    LoadPropertyViewing(CClientTourProperty, LabelReference9, LabelTimeHour9, LabelTimeMinute9)
                    TableRowProperty9.Visible = True

                Case Else
                    UpdatePropertyDetails(CClientTourProperty.PropertyID, LabelName10, LabelAddress10, LabelTown10, LabelContactNo10, LabelPrice10, LabelTimeHour10, LabelTimeSeparator10, LabelTimeMinute10, LabelKey10, LabelGPS_latitude10, LabelGPS_longitude10)
