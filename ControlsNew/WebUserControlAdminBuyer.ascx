...
<asp:UpdatePanel ID="UpdatePanelAdminBuyer" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        ...
        <h1>
            <asp:Label ID="LabelBuyer" runat="server" Text="Client"></asp:Label><asp:Button ID="btnAction" runat="server" Text="ACTION" Style="margin-left: 49px;" Visible="false" CssClass="default-button" PostBackUrl="~/Admin/BuyerActionAgenda.aspx" />
            <asp:Button ID="btnClintHistory" runat="server" Text="CLIENT HISTORY" Style="margin-left: 49px;" CssClass="default-button" PostBackUrl="~/Admin/ClientHistory.aspx" Visible="false" />
        </h1>
