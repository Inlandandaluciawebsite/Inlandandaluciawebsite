...
Partial Class WebUserControlAdminClientTourFeedback
    ...
    Private Sub CreateFeedbackEntry(ByVal nID As Integer, ByVal nClientTourID As Integer, ByVal nPropertyID As Integer, ByVal szPropertyRef As String)
        ...
        Dim ctrl As ASP.controlsnew_webusercontroladminclienttourfeedbackentry_ascx = CType(LoadControl("~/ControlsNew/WebUserControlAdminClientTourFeedbackEntry.ascx"), ASP.controlsnew_webusercontroladminclienttourfeedbackentry_ascx)
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            For Each ctrl As ASP.controlsnew_webusercontroladminclienttourfeedbackentry_ascx In UpdatePanelFeedback.ContentTemplateContainer.Controls
