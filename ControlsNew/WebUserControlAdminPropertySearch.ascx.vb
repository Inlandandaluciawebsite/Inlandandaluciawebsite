...
Partial Class WebUserControlAdminPropertySearch
    ...
    Private Sub PopulateAreasInCountry()
        ...
        ' Apply the Filter
        dv.RowFilter = "Country = '" & DropDownListCountry.SelectedValue.Trim & "'"
    ...
    Private Sub PopulateFilters()
        ...
        If Not Session("PropertyAdminPropertySearchResults") Is Nothing Then
            ...
            PopulateFilter(DropDownListCountry, DirectCast(Session("PropertyAdminPropertySearchResults"), DataTable), 6)
            InitFilter(DropDownListArea)
            InitFilter(DropDownListTown)
            PopulateFilter(DropDownListStatus, DirectCast(Session("PropertyAdminPropertySearchResults"), DataTable), 11)
            PopulateFilter(DropDownListType, DirectCast(Session("PropertyAdminPropertySearchResults"), DataTable), 5)
    ...
    Private Sub ApplyFilters()
        ...
        If DropDownListCountry.SelectedIndex > 0 Then
            ...
            ' Filter Results
            dvDataView.RowFilter = "Country='" & DropDownListCountry.SelectedValue & "'"
    ...
    Private Sub ApplyStyling()
        ...
        For Each gvr As GridViewRow In GridViewResults.Rows
            ...
            Select Case gvr.Cells(11).Text.Trim
            ...
            Select Case Convert.ToInt32(gvr.Cells(14).Text.Trim)

                Case 1
                    ' We have a Key, Add Image
                    Dim img As New Image
                    img.ImageUrl = "~/Images/Icons/door_key.png"
                    gvr.Cells(14).Controls.Add(img)

                Case Else
                    ' Clear Contents
                    gvr.Cells(14).Text = String.Empty
