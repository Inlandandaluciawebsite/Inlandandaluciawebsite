...
Partial Class SellWithUs
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Not Session("PropertyLocation") Is Nothing Then
                txtPropertyLocation.Text = Session("PropertyLocation")
            End If
            ...
            If Not Request.QueryString("reference") Is Nothing Then
                ...
                txtPropertyDetails.Text = "Hi" & vbCrLf & vbCrLf & "I am interested in property reference " & Request.QueryString("reference").ToUpper.Trim & ".  Please can you contact me regarding this property using the contact details provided?" & vbCrLf & vbCrLf & "Best Regards" & vbCrLf & vbCrLf

                ' If we have the First Name
                If Not Session("FirstName") Is Nothing Then
                    txtPropertyDetails.Text &= Session("FirstName")
                End If
    ...
    Protected Sub btnSendMessage_Click(sender As Object, e As EventArgs)
        ...
        If (Convert.ToInt16(lblFirstCaptchaValue.Text) + Convert.ToInt16(lblSecondCaptchaValue.Text)) = Convert.ToInt16(txtCaptchaValue.Text) Then
            ...
            Session("PropertyLocation") = StrConv(txtPropertyLocation.Text.Trim, VbStrConv.ProperCase)
            Session("Telephone") = TextBoxTelephone.Text.Trim
            Session("Email") = TextBoxEmail.Text.ToLower.Trim
            Session("Comment") = txtPropertyDetails.Text.Trim
            Dim sql As SqlParameter() = New SqlParameter(1) {}
    ...
    Private Sub SendMessageToEmail()
        ...
        If DateDiff(DateInterval.Second, Convert.ToDateTime(Session("ContactUsArrival")), Now) >= 3 Then
            ...
            If Page.Request.Url.AbsoluteUri.Contains("dev.inlandandalucia.com") Then
                szSubject = "Test - Vendor interested to list property "
                isDevORTraining = 1
            End If
            ...
            If isDevORTraining = 0 Then
                szSubject = "Vendor interested to list property "
            End If
            ...
            Dim szContent As String =
                "First Name:    " & TextBoxFirstName.Text & vbCrLf &
                "Last Name:     " & TextBoxLastName.Text & vbCrLf &
                "Telephone:     " & TextBoxTelephone.Text & vbCrLf &
                "Email:         " & TextBoxEmail.Text & vbCrLf &
                "Property Location:        " & txtPropertyLocation.Text & vbCrLf &
                "Property Details:       " & vbCrLf & vbCrLf & txtPropertyDetails.Text
            ...
            CEmail.SendEmailContactEnquiry("sourabhodesk@gmail.com", szSubject, szContent, False)
            CEmail.SendEmailContactEnquiry("jerome@inlandandalucia.com", szSubject, szContent, False)
