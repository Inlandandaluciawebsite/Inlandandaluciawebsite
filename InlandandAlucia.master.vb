...
Partial Public Class InlandandAlucia
    ...
    Private Sub bindblogslist()
        Dim dt As DataTable = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "Usp_tblBlogs_Menu").Tables(0)
        If dt.Rows.Count > 0 Then
            For Each dr As DataRow In dt.Rows
                liblogslist.InnerHtml = liblogslist.InnerHtml + "<li><a href='/Blog/" + dr("TitleNew") + "' title='" + dr("Title") + "'>" + dr("Title") + " </a></li>"
            Next
        End If
    End Sub
    ...
    Public Sub ActiveMenu()
        ...
        Dim csur As HtmlGenericControl = DirectCast(WebUserControlQuickSearch.FindControl("cuser"), HtmlGenericControl)
        Dim blog As HtmlGenericControl = DirectCast(WebUserControlQuickSearch.FindControl("blogright"), HtmlGenericControl)
        ...
        End If
        If Page.Request.Url.AbsoluteUri.Contains("Blog.aspx") Then
            liblogs.Attributes.Add("class", "dropdown active")
            csur.Style.Add(HtmlTextWriterStyle.Display, "none")
            blog.Style.Add(HtmlTextWriterStyle.Display, "block")
        End If
        If Page.Request.Url.AbsoluteUri.Contains("Blog") Then
            liblogs.Attributes.Add("class", "dropdown active")
            csur.Style.Add(HtmlTextWriterStyle.Display, "none")
            blog.Style.Add(HtmlTextWriterStyle.Display, "block")
        End If
        If Page.Request.Url.AbsoluteUri.Contains("BlogDetail.aspx") Then
            liblogs.Attributes.Add("class", "dropdown active")
            csur.Style.Add(HtmlTextWriterStyle.Display, "none")
            blog.Style.Add(HtmlTextWriterStyle.Display, "block")
        End If
        ...
        If Page.Request.Url.AbsoluteUri.Contains("SellWithUs.aspx") Then
            InlandAndaluciaSellWithUs.Attributes.Add("class", "dropdown active")
        End If
        If Page.Request.Url.AbsoluteUri.Contains("Buyer_Criterias.aspx") Then
            WebUserControlQuickSearch.Visible = False
        End If
        If Page.Request.Url.AbsoluteUri.Contains("buyer_criterias.aspx") Then
            WebUserControlQuickSearch.Visible = False
        End If
    ...
    Protected Sub ImageButtonEnglish_Click(sender As Object, e As EventArgs)
        ...
        Dim pageName2 As String = HttpContext.Current.Request.Url.ToString()

        Dim currentpage As String = pageName2.Substring(pageName2.LastIndexOf("/") + 1)
        If (pageName2.Contains("Blog.aspx")) Then
            Response.Redirect("~\en\" + currentpage)
        End If
        If (pageName2.Contains("Blog")) Then
            Response.Redirect("~\en\Blog\" + currentpage)
        End If
    ...
    Protected Sub ImageButtonSpanish_Click(sender As Object, e As EventArgs)
        ...
        End If
        If (pageName2.Contains("Blog")) Then
            Response.Redirect("~\es\Blog\" + currentpage)
        End If
        Response.Redirect("~\es\" + currentpage)
    End Sub
    ...
    Protected Sub ImageButtonFrench_Click(sender As Object, e As EventArgs)
        ...
        End If
        If (pageName2.Contains("Blog")) Then
            Response.Redirect("~\fr\Blog\" + currentpage)
        End If
        Response.Redirect("~\fr\" + currentpage)
    End Sub
    ...
    Protected Sub ImageButtonDutch_Click(sender As Object, e As EventArgs)
        ...
        End If
        If (pageName2.Contains("Blog")) Then
            Response.Redirect("~\de\Blog\" + currentpage)
        End If
        Response.Redirect("~\de\" + currentpage)
    End Sub
