<%@ Page Title="" Language="VB" MasterPageFile="~/InlandandAlucia.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Blog_Default" %>
<%@ Register Src="~/Controls/BlogHeader.ascx" TagPrefix="uc1" TagName="BlogHeader" %>
 <asp:Content ID="Contenttp" runat="server" ContentPlaceHolderID="ContentPlaceHolder3" >
       ...
       <link href="<%= ResolveUrl("~/css/Blog.css") %>" rel="stylesheet" />
           <link href="<%= ResolveUrl("~/css/popup.css") %>" rel="stylesheet" />
            ...
            <ItemTemplate>
                ...
                <div class="gray-bg-inner">
                    <div class="outer-border">
                      ...
                      <%--    <% If Convert.ToBoolean((IsSpanish)) = True Then %>
                         
                          <h3 class="blog-title"><a href="/Blog/<%#(Eval("TitleNew").ToString()) %>"> <asp:Literal ID="Literal4" Text="<%$Resources:Resource, TitleNewBlog %>" runat="server"></asp:Literal></a></h3>
                       <p class="blog-main-txt">
                         <asp:Literal ID="Literal1" Text="<%$Resources:Resource, SubTitleBlog %>" runat="server"></asp:Literal>
                        </p>
                        <p class="blog-main-txt">
                            <asp:Literal ID="Literal2" Text="<%$Resources:Resource, descblog %>" runat="server"></asp:Literal>
                        </p>
                        ...
                        <p class="blog-main-txt">
                            ...
                            <script>
                                alert('<%#Eval("Description").ToString()%>');
                            </script>
                        </p>
                        <p class="blog-main-txt">Posted by: <%#Eval("PostedByUser").ToString() %> on <%#Eval("dateposted").ToString() %> </p>
                        <p class="blog-main-txt">
                            Labels: <%#Server.HtmlDecode(Eval("hashlables").ToString()) %>
                        </p>
                    <%--  <% End If %>--%>
            ...
            <div class="social_login">
                <div class="">
                 ...
                 <%--   <asp:ImageButton ID="ass"  runat="server"  >
                    ...
                    <asp:ImageButton ID="lblloginwithfb" runat="server" ImageUrl="~/images/facebooklogin.png"  class="social_box fb" OnClick="lblloginwithfb_Click" >
