                                        ...
                                        <tr>
                                            <td colspan="6">
                                                ...
                                                <asp:GridView ID="grdNoVideosProperties" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    DataKeyNames="Property_Ref" AllowPaging="True" OnRowDataBound="grdNoVideosProperties_RowDataBound"  AllowSorting="true" PageSize="15" OnPageIndexChanging="grdNoVideosProperties_PageIndexChanging" OnSorting="grdNoVideosProperties_Sorting" HeaderStyle-BackColor="#2D3091" HeaderStyle-ForeColor="White" RowStyle-Height="50">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
