    ...
    <ContentTemplate>     
        ...
        <asp:Table ID="TableTourBody" runat="server" Width="100%" BorderWidth="0" 
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Center" style="width:100px" >
                    <strong>Ref.</strong>
                </asp:TableCell>
               <asp:TableCell HorizontalAlign="Center" style="width:100px">
                   Partner Ref.
                ...
                <asp:TableCell Width="70px" HorizontalAlign="Center" style="width:100px" >
                    <strong>Price</strong>
                </asp:TableCell>
            
                <asp:TableCell Width="100px" HorizontalAlign="Center" style="width:100px" >
                    <strong>Time</strong>
                </asp:TableCell>
            ...
            <asp:TableCell>
                    <asp:Label ID="Labelpartner1" runat="server"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
            ...
            <asp:TableRow ID="TableRowProperty2" runat="server" Visible="false" >
              ...
              <asp:TableCell>
                    <asp:Label ID="Labelpartner2" runat="server"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
            ...
            <asp:TableRow ID="TableRowProperty3" runat="server" Visible="false" >
              ...
              <asp:TableCell>
                    <asp:Label ID="Labelpartner3" runat="server"></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
