...
Partial Class WebUserControlPropertyOverview
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("ContactID") Is Nothing Then
            ...
            MoreInfoButton.InnerHtml = "<a href='propsearch.aspx?propertyid=" & dt.Rows(0)("Property_ID").ToString() & "' title=""more information""><img src=""" & GetImagePath() & """ alt=""More info"" name=""More information"" width=""116"" height=""31"" border=""0"" id=""More information"" /></a>"
    ...
    Protected Sub ImageProperty_Click1(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageProperty.Click
        ...
        If Session("ContactID") Is Nothing Then
            ...
            Response.Redirect("propsearch.aspx?propertyid=" & dt.Rows(0)("Property_ID").ToString())
