...
Partial Class WebUserControlAdminClientTourPropertySelection
    ...
    Private Sub PopulateResults()
        ...
        If Not Session("AdminClientTourPropertySearchFilteredResults") Is Nothing Then
            ...
            If dtResults.Rows.Count > 0 Then
                ...
                Dim ctrlResultsHeader As ASP.controls_webusercontroladminpropertysearchresultsheader_ascx = CType(LoadControl("~/Controls/WebUserControlAdminPropertySearchResultsHeader.ascx"), ASP.controls_webusercontroladminpropertysearchresultsheader_ascx)
                ...
                For Each dr As DataRow In dtResults.Rows
                    ...
                    If bDisplay Then
                        ...
                        ' Create a New Control
                        Dim ctrlResult As ASP.controls_webusercontroladminpropertysearchresult_ascx = CType(LoadControl("~/Controls/WebUserControlAdminPropertySearchResult.ascx"), ASP.controls_webusercontroladminpropertysearchresult_ascx)
