...
Partial Class WebUserControlSearchResults
    ...
    Private Property Features As String
        Get
            Return m_szFeatures
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Private m_nMinimumplotsize As Integer
    Public Property Minimumplotsize() As Integer
        Get
            Return m_nMinimumplotsize
        End Get
        Set(ByVal value As Integer)
            m_nMinimumplotsize = value
        End Set
    End Property
    ...
    Private Sub LoadResults()
        ...
        If Session("ContactPartnerID") Is Nothing Then
            ...
            dtResults = CDataAccess.SearchResults(CUtilities.GetLanguageID(Session("Language")),
                                                                   ...
                                                                   MaximumPrice,
                                                                   SortOrder,
                                                  Features, Minimumplotsize)

        Else


            If Not String.IsNullOrEmpty(Request.QueryString("IsFeatured")) Then
                ' Logged in as a Partner
                dtResults = CDataAccess.SearchResultsOnlyFeatured(CUtilities.GetLanguageID(Session("Language")), Convert.ToInt32(Session("ContactPartnerID")))
                NavigationTop.Visible = False
                NavigationBottom.Visible = False
                Filtering.Visible=False
            Else
                ' Logged in as a Partner
                dtResults = CDataAccess.SearchResultsNew(CUtilities.GetLanguageID(Session("Language")),
                                                                       RegionID,
                                                                       AreaID,
                                                                       SubAreaID,
                                                                       Session("SearchMode") = "Top30",
        ...
        If NumberOfResults > 0 Then
            ...
            For Each dr As DataRow In dtResults.Rows
                ...
                Dim pagecountnew As Int16 = 9
                If Not String.IsNullOrEmpty(Request.QueryString("IsFeatured")) Then
                    pagecountnew = 1000
                End If

                ' If we have Added 10 to the Table
                If nRowCounter > pagecountnew Then
            ...
            If NumberOfPages > 1 And Session("PageNumber") > 1 Then
                ...
                Select Case Session("SearchMode")
                    ...
                    Case "AgentArea"
                        ...
                        ' Add the Back Option
                        NavigationTop.InnerHtml &= "<a href='AgentArea.aspx?" &
                                                    "page=" & (Convert.ToInt32(Session("PageNumber")) - 1).ToString.Trim &
                                                    "&amp;regionid=" & RegionID.ToString.Trim &
                                                    "&amp;areaid=" & AreaID.ToString.Trim &
                                                    "&amp;subareaid=" & SubAreaID.ToString.Trim &
                                                    "&amp;typeid=" & TypeID.ToString.Trim &
                                                    "&amp;minimumbedrooms=" & MinimumBedrooms.ToString.Trim &
                                                    "&amp;minimumbathrooms=" & MinimumBathrooms.ToString.Trim &
                                                    "&amp;minimumprice=" & MinimumPrice.ToString.Trim &
                                                    "&amp;maximumprice=" & MaximumPrice.ToString.Trim &
                                                      "&amp;features=" & Features.ToString.Trim &
                                                            "&amp;plotsize=" & Minimumplotsize.ToString.Trim &
                                                    " '>&lt;Prev&gt;</a>&nbsp"
                ...
                Else
                    ...
                    Select Case Session("SearchMode")
                        ...
                        Case Else
                            ...
                            ' Add this Page as a Link
                            NavigationTop.InnerHtml &= "<a href='propsearch.aspx?" &
                                                        "page=" & nPage.ToString.Trim &
                                                        "&amp;regionid=" & RegionID.ToString.Trim &
                                                        "&amp;areaid=" & AreaID.ToString.Trim &
                                                        "&amp;subareaid=" & SubAreaID.ToString.Trim &
    ...
    Private Sub LoadFiltering()
        ...
        If RegionID = 0 Then
            ...
            Else
                ...
                ' Getting the List of Regions
                dtDataTable = CDataAccess.RegionsIncPropertyCountsNew(TypeID, MinimumBedrooms, MinimumBathrooms, MinimumPrice, MaximumPrice, Features, Minimumplotsize)
                ...
                If Convert.ToInt32(dr("count")) > 0 Then
                    ...
                    Select Case Session("SearchMode")
                        ...
                        Case "AgentArea"
                            ...
                            ' Constructing the HTML
                            Filtering.InnerHtml &= szDelimter & "<a href='AgentArea.aspx?page=1" &
                                                                "&amp;regionid=" & (Convert.ToInt32(dr("id"))).ToString.Trim &
                                                                "&amp;areaid=0" &
                                                                "&amp;subareaid=0" &
                                                                "&amp;typeid=" & TypeID.ToString.Trim &
                                                                "&amp;minimumbedrooms=" & MinimumBedrooms.ToString.Trim &
        ...
        Else
            ...
            If AreaID = 0 Then
                ...
                Else
                    ...
                    ' Getting the List of Areas
                    dtDataTable = CDataAccess.AreasIncPropertyCountsNew(RegionID, TypeID, MinimumBedrooms, MinimumBathrooms, MinimumPrice, MaximumPrice, Features, Minimumplotsize)
                    ...
                    If Convert.ToInt32(dr("count")) > 0 Then
                        ...
                        Select Case Session("SearchMode")
                            ...
                            Case "AgentArea"
                                ...
                                Filtering.InnerHtml &= szDelimter & "<a href='AgentArea.aspx?page=1" &
                                                                    "&amp;regionid=" & RegionID.ToString.Trim &
                                                                    "&amp;areaid=" & (Convert.ToInt32(dr("id"))).ToString.Trim &
                                                                    "&amp;subareaid=0" &
                                                                    "&amp;typeid=" & TypeID.ToString.Trim &
                                                                    "&amp;minimumbedrooms=" & MinimumBedrooms.ToString.Trim &
                                                                    "&amp;minimumbathrooms=" & MinimumBathrooms.ToString.Trim &
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Features = Convert.ToString(Session("features"))
        Minimumplotsize = Convert.ToInt32(Session("plotsize"))
