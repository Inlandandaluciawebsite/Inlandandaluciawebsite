...
Partial Class WebUserControlAdminClientTour
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            Dim dtDataTable As DataTable = CDataAccess.ClientTourProperties(Session("ContactPartnerID"))
    ...
    Private Sub UpdatePropertyDetails(ByVal nPropertyID As Integer, ByRef lblName As Label, ByRef lblAddress As Label, ByRef lblTown As Label, ByRef lblContactNo As Label, ByRef lblPrice As Label, ByRef ddlHour As DropDownList, ByRef lblSeparator As Label, ByRef ddlMinute As DropDownList, ByRef lblKey As Label)
        ...
        Else
            ...
            ' No Data - Clear
            ClearRow(lblName, lblAddress, lblTown, lblContactNo, lblPrice, ddlHour, lblSeparator, ddlMinute, lblKey)
    ...
    Private Sub ClearRow(ByRef lblName As Label, ByRef lblAddress As Label, ByRef lblTown As Label, ByRef lblContactNo As Label, ByRef lblPrice As Label, ByRef ddlHour As DropDownList, ByRef lblSeparator As Label, ByRef ddlMinute As DropDownList, ByRef lblKey As Label)
    ...
    Private Sub ProcessPropertySelection(ByRef ddl As DropDownList,
        ...
        If PropertyPreviouslySelected(ddl) Then
            ...
            ' Clear the Row
            ClearRow(lblName, lblAddress, lblTown, lblContactNo, lblPrice, ddlTimeHour, lblTimeSeparator, ddlTimeMinute, lblKey)
        ...
        Else
            ...
            If ddl.SelectedIndex > 0 Then
                ...
                UpdatePropertyDetails(Convert.ToInt32(ddl.SelectedValue), lblName, lblAddress, lblTown, lblContactNo, lblPrice, ddlTimeHour, lblTimeSeparator, ddlTimeMinute, lblKey)
    ...
    Protected Sub DropDownListReference1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference1.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference1, LabelName1, LabelAddress1, LabelTown1, LabelContactNo1, LabelPrice1, DropDownListTimeHour1, LabelTimeSeparator1, DropDownListTimeMinute1, LabelKey1)
    End Sub
    ...
    Protected Sub DropDownListReference2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference2.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference2, LabelName2, LabelAddress2, LabelTown2, LabelContactNo2, LabelPrice2, DropDownListTimeHour2, LabelTimeSeparator2, DropDownListTimeMinute2, LabelKey2)
    End Sub
    ...
    Protected Sub DropDownListReference3_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference3.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference3, LabelName3, LabelAddress3, LabelTown3, LabelContactNo3, LabelPrice3, DropDownListTimeHour3, LabelTimeSeparator3, DropDownListTimeMinute3, LabelKey3)
    End Sub
    ...
    Protected Sub DropDownListReference4_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference4.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference4, LabelName4, LabelAddress4, LabelTown4, LabelContactNo4, LabelPrice4, DropDownListTimeHour4, LabelTimeSeparator4, DropDownListTimeMinute4, LabelKey4)
    End Sub
    ...
    Protected Sub DropDownListReference5_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference5.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference5, LabelName5, LabelAddress5, LabelTown5, LabelContactNo5, LabelPrice5, DropDownListTimeHour5, LabelTimeSeparator5, DropDownListTimeMinute5, LabelKey5)
    End Sub
    ...
    Protected Sub DropDownListReference6_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference6.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference6, LabelName6, LabelAddress6, LabelTown6, LabelContactNo6, LabelPrice6, DropDownListTimeHour6, LabelTimeSeparator6, DropDownListTimeMinute6, LabelKey6)
    End Sub
    ...
    Protected Sub DropDownListReference7_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference7.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference7, LabelName7, LabelAddress7, LabelTown7, LabelContactNo7, LabelPrice7, DropDownListTimeHour7, LabelTimeSeparator7, DropDownListTimeMinute7, LabelKey7)
    End Sub
    ...
    Protected Sub DropDownListReference8_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference8.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference8, LabelName8, LabelAddress8, LabelTown8, LabelContactNo8, LabelPrice8, DropDownListTimeHour8, LabelTimeSeparator8, DropDownListTimeMinute8, LabelKey8)
    End Sub
    ...
    Protected Sub DropDownListReference9_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference9.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference9, LabelName9, LabelAddress9, LabelTown9, LabelContactNo9, LabelPrice9, DropDownListTimeHour9, LabelTimeSeparator9, DropDownListTimeMinute9, LabelKey9)
    End Sub
    ...
    Protected Sub DropDownListReference10_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownListReference10.SelectedIndexChanged
        ProcessPropertySelection(DropDownListReference10, LabelName10, LabelAddress10, LabelTown10, LabelContactNo10, LabelPrice10, DropDownListTimeHour10, LabelTimeSeparator10, DropDownListTimeMinute10, LabelKey10)
    End Sub
