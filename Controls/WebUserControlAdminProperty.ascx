...
<div id="menu" style="width:120px;float:left;">
    <h4>
        <asp:Label ID="LabelPropertyReference" runat="server" Text=""></asp:Label>
      
    </h4>
    <br />
  
         <asp:LinkButton ID="lblpartnerref" runat="server" Text=""  Visible ="false" ></asp:LinkButton>
    <asp:Button id="btnedirref" runat="server" Text="Edit Reference" Visible ="false"  CssClass="default-button" />
    <br />
...
<div id="content" style="width:940px; float:left;">
    ...
    <asp:Table ID="TableGeneral" runat="server" Width="93%">
        <asp:TableRow>
        ...
        <asp:TableRow ID="TableRowUnderOfferTo" runat="server" Visible="false">
            ...
            <asp:TableCell>
                <asp:DropDownList ID="DropDownListUnderOfferTo" runat="server" AutoPostBack="true"></asp:DropDownList>
                 <asp:Button ID="ButtonUnderOfferTo" runat="server" Text="View"  CssClass="default-button"/>      
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow Visible="false">
            ...
            <asp:TableCell>
               ...
               <asp:TableCell VerticalAlign="Top"  HorizontalAlign="Right">
                <asp:Label ID="lbltaxvalu" runat="server" Text="TAXABLE Values"></asp:Label>
            </asp:TableCell>   
              <asp:TableCell  HorizontalAlign="Right">
                <asp:TextBox ID="txtTAXABLEval" runat="server" MaxLength="250" TextMode="MultiLine" Width="300px" Rows="4" AutoCompleteType="None"></asp:TextBox>
        ...
        <asp:TableRow Visible="false" >
            ...
            <asp:TableCell>
                <asp:DropDownList ID="DropDownListBroker" runat="server" Enabled="false" ></asp:DropDownList>&nbsp; <asp:Button ID="LinkButtonSTBrokerAdd" runat="server" Text="Add" OnClientClick="javascript:document.getElementById('AdminNavigation_LinkButtonSTBrokerAdd').click(); return false;" CssClass="default-button" style="display:none" />
            </asp:TableCell>
        </asp:TableRow>
    ...
    <asp:Table ID="tblpropref" runat="server" Visible="false">
            <asp:TableRow >
            <asp:TableCell>
              Property Partner Reference
            </asp:TableCell>
            <asp:TableCell>
             <asp:TextBox ID="txtpropref" runat="server"  MaxLength="7" AutoCompleteType="None"></asp:TextBox> 
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    ...
    <asp:Table ID="TableUploadImages" runat="server" Visible="false">
        ...
        <asp:TableRow ID="TableRowImageOptions" runat="server">
            ...
            <asp:TableCell>
                <asp:Button ID="ButtonBulkUploadImage" runat="server" Text="Bulk" CssClass="default-button" style="display:none"/>
            </asp:TableCell>    
        </asp:TableRow>
        ...
        <asp:TableRow ID="TableRowSoldTo" runat="server" Visible="false">
            <asp:TableCell>
                Buyer: <asp:DropDownList ID="DropDownListBuyer" runat="server" AutoPostBack="true" ></asp:DropDownList>
                 <asp:Button ID="ButtonViewBuyer" runat="server" Text="View"  CssClass="default-button"/>       
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
    ...
    <asp:Table ID="TableDocuments" runat="server" Font-Names="Calibri" Visible="false">
        ...
        <asp:TableRow ID="TableRowFolderOptions" runat="server">
            ...
            <asp:TableCell>
                ...
                <asp:TableCell>
                <asp:Button ID="btnMove" runat="server" Text="Move" Enabled="false" CssClass="default-button"/>
            </asp:TableCell>
            <asp:TableCell >
            ...
            <asp:TableCell>
               <asp:CheckBox ID="chkIsIssue"  CssClass="default-button new-c" runat="server" Text="Issue" AutoPostBack="true" OnCheckedChanged="chkIsIssue_CheckedChanged" />
            </asp:TableCell>
        </asp:TableRow> 
        <asp:TableRow ID="TableRowUpdate" runat="server" Visible="false">
            ...
            <asp:TableCell HorizontalAlign="Left">
             ...
             <asp:TableRow ID="TableRowMove" runat="server" Visible="false">
            ...
            <asp:TableCell>
                <asp:Button ID="ButtonMoveYes" runat="server" Text="Yes" CssClass="default-button"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Button ID="ButtonMoveNo" runat="server" Text="No" CssClass="default-button"/>
            </asp:TableCell>
        </asp:TableRow> 
    ...
    <asp:Table ID="TableSave" runat="server" Width="100%" >
        ...
        <asp:TableCell HorizontalAlign="Left" Width="50px">
              ...
              <asp:TableCell ID="tblback" runat="server" Visible="false">
                   <asp:Button ID="btnvack" runat="server" Text="Back" Visible="true" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" CssClass="default-button" />
            </asp:TableCell>
      ...
      <%--  <asp:Table ID="tblback" runat="server" Width="100%"  Visible="false" >
        <asp:TableRow>
        <asp:TableCell HorizontalAlign="Left">
