...
Partial Class WebUserControlAdminTestimonials
    ...
    Private Sub AddTestimonial(Optional ByVal nTestimonialID As Integer = 0,
        ...
        Dim ctrl As ASP.controls_webusercontroladmintestimonial_ascx

        ' Create a New Control
        ctrl = CType(LoadControl("~/Controls/WebUserControlAdminTestimonial.ascx"), ASP.controls_webusercontroladmintestimonial_ascx)
