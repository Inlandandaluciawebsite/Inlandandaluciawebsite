<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Copy of WebUserControlAdminPostcodes.ascx.vb" Inherits="WebUserControlAdminPostcodes" %>
<%@ Register Src="~/Controls/WebUserControlAdminPostcodeReassignment.ascx" TagName="AdminPostcodeReassignment" TagPrefix="ucAdminPostcodeReassignment" %>
