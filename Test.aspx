...
<div class="clearfloat"></div>
  ...
  <div id="mainContent">
  <h1><%=GetTranslation("The weather in Andalucia")%>:</h1>
  <p><%=GetTranslation("Check the Weather Forecast in any region of Andalucia by clicking the Map")%></p>
...
<p>&nbsp;</p>
<p><%=GetTranslation("Or check it on differents towns of each region in Andalucia")%>
...
<span class="BlueText">
  ...
  <hr />
  <p><strong><%=GetTranslation("Below is a list of our inland properties in Andalucia sorted by province and in alphabetical order")%>:</strong></p>
