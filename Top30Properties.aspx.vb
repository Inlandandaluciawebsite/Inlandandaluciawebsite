...
Partial Class Top30Properties
    ''   Inherits System.Web.UI.Page
    Inherits BasePage
    Private PageSize As Integer = 10
    Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load

        Page.Title = "Inland Andalucia | Top 30 properties Andalucia"
    ...
    Private Sub bindFeaturedProperty(pageIndex As Integer)
        ...
        Dim dt As DataTable = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "Usp_Property_ListbyPagingtop30", sql).Tables(0)
