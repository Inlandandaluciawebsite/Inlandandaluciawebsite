<%@ Page Title="" Language="VB" MasterPageFile="~/InlandandAlucia.master" AutoEventWireup="false" CodeFile="JaenInfo.aspx.vb" Inherits="JaenInfo" %>
    ...
    <div class="col-md-8">
        ...
        <div class="row">
            <div class="jaen-info">
                <div class="col-md-5 col-sm-5">
                    <div class="jaen-info">
                        <img class="img-bdr" src="/images/jaen1.jpg" alt="plan" />
                    </div>
                </div>
        ...
        <div class="row">
            <div class="jaen-info">
                ...
                <div class="col-md-5 col-sm-5">
                    <div class="jaen-info">
                        <img class="img-bdr" src="/images/jaen2.jpg" alt="plan" />
                    </div>
                </div>
