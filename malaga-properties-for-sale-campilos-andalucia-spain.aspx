<%@ Page Title="" Language="VB" MasterPageFile="~/InlandandAlucia.master" AutoEventWireup="false" CodeFile="malaga-properties-for-sale-campilos-andalucia-spain.aspx.vb" Inherits="CampillosLocationInfo" %>
          ...
          <!-- View trip listing Start -->
            ...
            <div class="">
              <div class="town-guide-hd">
                    <div class="col-md-8"> <h1>Campillos Andalucia</h1></div>
           <div class="col-md-4"><a href="propsearch.aspx?page=1&regionid=4&areaid=182&SubAreaId=0&sort=price_asc"><asp:Literal ID='Literal16' Text='<%$Resources:Resource, Viewpropertiesinthistown %>' runat='server'></asp:Literal></a></div>  
              </div>
            </div>
          </div>
...
<p><asp:Literal ID='Literal1' Text='<%$Resources:Resource, CampillosLocationDetail %>' runat='server'></asp:Literal></p>          <!-- Detail one Strat -->
          </div> 
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="quick-information-about-mollina">
                <h3><asp:Literal ID='Literal2' Text='<%$Resources:Resource, QuickInformationAbout %>' runat='server'></asp:Literal> Campillos:</h3>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="map-pin">
              <div class="col-md-4 col-sm-4">
                <div class="map-pin-inner"> <img src="/images/residents.png">
                  <p> 8.400 <asp:Literal ID='Literal3' Text='<%$Resources:Resource, residents %>' runat='server'></asp:Literal>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="monilla-loc">
               ...
               <%-- google map --%>
                  <h3>
Campillos <asp:Literal ID='Literal14' Text='<%$Resources:Resource, Location %>' runat='server'></asp:Literal></h3>
      ...
      <div class="divider"><img src="/images/divider.png"></div>
          ...
          <div class="row">
            <div class="location-info">
              ...
              <img src="/images/photos/TownLocationInfo/campillos_coa.gif" alt="Campillos Coat of Arms">
                <h5>Ayuntamiento de Campillos</h5>
                 <p>

Avenida Santa Maria del Reposo, 4
29320 Campillos, Málaga
Telephone: 952-722-168</p>
          ...
          <div class="row">
            <div class="cordoba-details-2">
              <div class="col-md-12">
           <h3>
Campillos <asp:Literal ID='Literal17' Text='<%$Resources:Resource, Information %>' runat='server'></asp:Literal></h3>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="mollina-information-dtl">
              <div class="col-md-8 col-sm-8">
                <div class="mollina-information-dtl">
<p><asp:Literal ID='Literal18' Text='<%$Resources:Resource, CampillosLocationDetail1 %>' runat='server'></asp:Literal></p>
                    <p><asp:Literal ID='Literal19' Text='<%$Resources:Resource, CampillosLocationDetail2 %>' runat='server'></asp:Literal> </p>
                    <p><asp:Literal ID='Literal20' Text='<%$Resources:Resource, CampillosLocationDetail3 %>' runat='server'></asp:Literal></p>
                   <p><asp:Literal ID='Literal21' Text='<%$Resources:Resource, CampillosLocationDetail4 %>' runat='server'></asp:Literal></p>
                    <p><asp:Literal ID='Literal22' Text='<%$Resources:Resource, CampillosLocationDetail5 %>' runat='server'></asp:Literal></p>
                    <p><asp:Literal ID='Literal23' Text='<%$Resources:Resource, CampillosLocationDetail6 %>' runat='server'></asp:Literal></p>
                    <p><asp:Literal ID='Literal24' Text='<%$Resources:Resource, CampillosLocationDetail7 %>' runat='server'></asp:Literal></p>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="mollina-information-dtl"> <img class="img-bdr" src="/images/photos/TownLocationInfo/Campillos(1).jpg" alt="Campillos Andalucia street">

                      <img class="img-bdr" src="/images/photos/TownLocationInfo/campillos2.jpg" alt="Campillos Andalucia feast">
                     <img class="img-bdr" src="/images/photos/TownLocationInfo/campillos3.jpg" alt="Campillos Andalucia building">
                               <img class="img-bdr" src="/images/photos/TownLocationInfo/campillos4.jpg" alt="Campillos Andalucia patio">
                </div>
              </div>
            </div>
          </div>
