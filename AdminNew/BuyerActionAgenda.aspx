<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="BuyerActionAgenda.aspx.vb" Inherits="Admin_BuyerActionAgenda" %>
                            ...
                            <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="drpAgents" runat="server" Enabled="false" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail2">Action Type</label>
                                        <asp:DropDownList ID="drpBuyerStatus" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="drpActionStatus" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpActionStatus_SelectedIndexChanged">
