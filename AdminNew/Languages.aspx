<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="Languages.aspx.vb" Inherits="BuyerSource" %>
...
<div id="TableUpdateSystemVariables" runat="server">
    ...
    <div class="row"  id="TableRowCode" runat="server" Visible="true">
          <div class="col-md-6">   
    <div class="form-group">
                                                    <label class="control-label col-md-3">Code:</label>
                                                    <div class="col-md-9">
                                                     <asp:TextBox ID="TextBoxCode" runat="server" MaxLength="3" CssClass="form-control"></asp:TextBox>
                                                    </div>
                                                    </div>            
                                                </div> 
