...
Partial Class Admin_ExclusiveProperties
    ...
    Protected Sub grdAdmin_RowDataBound1(sender As Object, e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            End If
            If lblIsTour.Text = "0" And lblIsEightWeeks.Text = "1" Then
                e.Row.BackColor = System.Drawing.Color.Blue
            End If
            If lblIsTour.Text = "0" And lblIsEightWeeksFeatured.Text = "1" And lblIsFeatured.Text = "1" And lblStatus.Text = "For Sale" And (drpColors.SelectedItem.Value = "0" Or drpColors.SelectedItem.Value = "Orange") Then
    ...
    Public Function populateGridView() As DataTable
        ...
        sql(9) = New SqlParameter("@IsFeatured", 1)
        Dim dt As DataTable
        ...
        If drpColors.SelectedItem.Value <> "0" Then
            ...
            If drpColors.SelectedItem.Text = "Blue" Then
                dataView.RowFilter = "Toured=0 AND IsEightWeeks=1 AND IsFeatured=0 AND Status='For Sale'"
            End If
            If drpColors.SelectedItem.Text = "Orange" Then
                dataView.RowFilter = "Toured=0 AND IsEightWeeksFeatured=1 AND IsFeatured=1 AND Status='For Sale'"
            End If
