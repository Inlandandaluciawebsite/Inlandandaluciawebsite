<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ManageVendors.aspx.vb" Inherits="Admin_ManageVendors" %>
          ...
          function postclick(args) {
              ...
              $(".clspager").find("td").find("table").find("tbody").find("tr").find("td").each(function () {
                  ...
                  if ( vl== args)
                  {
                      ...
                      __doPostBack('ctl00$ContentPlaceHolder1$grdAdmin', 'Page$' + args)
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">Manage Vendor </div>
                      ...
                      <div id="sample_1_filter" class="inp">
                            <asp:TextBox ID="txtname" runat="server"  class="form-control srchvend" placeholder="Name" aria-controls="sample_1" />
                             ...
                             <div class="col-md-3 col-sm-3">
                                  <asp:TextBox ID="txtprop" runat="server" class="form-control srchvend" placeholder="Property Refrence" aria-controls="sample_1" style="text-transform:uppercase" />

                     
               </div>
                              <div class="col-md-5 col-sm-5">
                                     <asp:CheckBox ID="chkarchived" runat="server" Text="Include Archived"  class="input-small input-inline srchvendarch"/>

                        <asp:Button ID="imgsearch" OnClick="imgsearch_Click1"  ToolTip="click here to search by Name, Refrence and Archived ..!!" runat="server"  class="btn green srchvendsrch" Text="Search" ></asp:Button>
                                    ...
                                    <tr role="row" style="border: 1px solid #ddd">
                                        <asp:GridView ID="grdAdmin" DataKeyNames="contact_id" OnRowDataBound="grdAdmin_RowDataBound1" AllowPaging="true" PageSize="10" Font-Names="Open Sans, sans-serif" class="sorting  table-hover " HeaderStyle-Height="20px" BorderColor="#dddddd" OnRowCommand="grdAdmin_RowCommand" OnPageIndexChanging="grdAdmin_PageIndexChanging" TabIndex="0" runat="server" AutoGenerateColumns="false" Width="100%" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Vendor Name" HeaderStyle-Width="219px" HeaderStyle-Height="20px">
                                                    <ItemTemplate>
                                                        <%#Eval("contact_name") %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                              
                                                <asp:TemplateField HeaderText="Vendor Mobile" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Mobile")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Vendor Email" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Email")%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="View" HeaderStyle-Width="46px" >
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgView" runat="server" CommandArgument='<%#Eval("contact_id") %>' ToolTip="Click to edit or view this vendor " CommandName="editadmin" ImageUrl="~/Admin/images/view-img.png" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
