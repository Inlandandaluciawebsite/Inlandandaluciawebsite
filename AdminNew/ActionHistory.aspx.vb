...
Public Class ActionHistory
                ...
                If Request.QueryString.HasKeys() Then
                    ...
                    If Request.QueryString("Type").ToString() = "Buyer" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            ...
                            BindStatus("Buyer")
                            If Not Convert.ToString(dt.Rows(0)("Buyer_Status")) = "1" Then
                                drpStatus.Items(drpStatus.Items.IndexOf(drpStatus.Items.FindByValue(dt.Rows(0)("Buyer_Status").ToString()))).Selected = True
                            End If
    ...
    Public Sub BindStatus(type As String)
        Dim strProcedure As String = "USP_BUYER_STATUS_SELECT"
        Dim strValueField As String = "Buyer_Status_Id"
    ...
    Public Sub BindAction(type As String)
        ...
        If type = "Buyer" Then
            ...
            If Convert.ToInt32(Session("AdminUser")) = 0 Then
                ...
                dt = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "USP_BUYER_FUTURE_SELECT_All_All_Status_By_UserId", sql).Tables(0)
            Else
    ...
    Protected Sub grdBuyerActionAgenda_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "EditBuyer" Then
            Response.Redirect("ActionHistory.aspx?History_ID=" + e.CommandArgument.ToString() + "&Type=Buyer")
        End If
    End Sub
    Protected Sub btnClientHistoryUpdate_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("ActionHistory.aspx?Type=" + drpActionAgendaType.SelectedValue)
    End Sub
