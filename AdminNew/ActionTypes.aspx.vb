...
Partial Class ActionTypes
    ...
    Public Sub InitForm()
        ...
        ' Check we have the Table we are Updatin Session("AdminSystemTable") = 2
        Dim CDataAccess As New ClassDataAccess

        LabelTitle.Text = "Action Types"
        GridViewResults.DataSource = CDataAccess.ActionTypesAll
    ...
    Protected Sub GridViewResults_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewResults.SelectedIndexChanged
        ...
        If 11 = ClassDataAccess.E_SystemVariable.Type Then
    ...
    Protected Sub ButtonDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
        ...
        Else
            ...
            GridViewPropertiesAffected.DataSource = CDataAccess.PropertiesUsingSystemVariable(11, Convert.ToInt32(Session("AdminSystemID")), Convert.ToInt32(Session("ContactPartnerID")))
            ...
            Else
                ...
                CDataAccess.RemoveSystemVariable(11, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            ' Save Entity
            CDataAccess.SaveSystemVariable(11, alEntries, Convert.ToInt32(Session("AdminSystemID")), TextBoxCode.Text.Trim.ToUpper)
    ...
    Private Sub DisplayEditFields()
        ...
        TableRowCode.Visible = (11 = ClassDataAccess.E_SystemVariable.Type)
        ButtonDelete.Visible = (11 <> ClassDataAccess.E_SystemVariable.Language)
