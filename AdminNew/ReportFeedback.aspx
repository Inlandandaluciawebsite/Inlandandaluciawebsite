<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ReportFeedback.aspx.vb" Inherits="ReportFeedback" %>
 ...
 <asp:Literal ID="Literal13" Text="Back" runat="server"></asp:Literal></a>
        ...
        <asp:Table ID="TableTourHeader" runat="server" Width="100%"  CssClass="table">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell ColumnSpan="2">
                    <asp:DropDownList ID="DropDownListTouredWith" runat="server" Width="100%" Enabled="false" ></asp:DropDownList>
                </asp:TableCell>
        ...
        <asp:Table ID="TableOptions" runat="server" Width="100%">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell Width="10%" HorizontalAlign="Right">
                    <asp:Button ID="ButtonFeedback" runat="server" Text="Feedback" Visible="true" CssClass="btn green"/>
                </asp:TableCell>
                <asp:TableCell Width="10%" HorizontalAlign="Right">
