<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="AddPartner.aspx.vb" Inherits="AddPartner" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" lang="javascript">
        function Validations() {
            ...
            IsError += ValidateRequiredField(document.getElementById('<%=txtEmail.ClientID%>'), "Please enter email!");
        ...
        <ContentTemplate>
            ...
            <%-- <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="AddPartner.aspx">Add Partner</a>
                    </li>
                </ul>
            </div>--%>
            <!-- /.modal -->
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <asp:Label ID="lblHeading" runat="server" Text="Add/Edit Partner"></asp:Label>
                                    </div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <h1>
                                            ...
                                            <asp:Button ID="btnAction" runat="server" Text="ACTION" Visible="false" CssClass="btn green" OnClick="btnAction_Click" />
                                            <asp:Button ID="btnClintHistory" runat="server" Text="FRANCHISE HISTORY" CssClass="btn green" Visible="false" OnClick="btnClintHistory_Click" />
                                        </h1>
                                        <!--/row-->
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:TextBox ID="txtCommission" runat="server" Visible="false" CssClass="form-control" MaxLength="10">
                                                        </asp:TextBox>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <asp:DropDownList ID="drppartner" runat="server" Visible="false" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
