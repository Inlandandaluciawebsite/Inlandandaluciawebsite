<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="BrokerList.aspx.vb" Inherits="BrokerList" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">Manage Broker </div>
 ...
 <asp:Literal ID="Literal13" Text="Back" runat="server"></asp:Literal></a>
                ...
                <div class="portlet-body">
                  ...
                  <%--                              <asp:TemplateField HeaderText="" HeaderStyle-CssClass="thwdth">
                                                ...
                                                <asp:TemplateField HeaderText="Broker Name" HeaderStyle-Width="219px" HeaderStyle-Height="20px">
                                                    <ItemTemplate>
                                                        <%#Eval("contact_name") %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                              
                                                <asp:TemplateField HeaderText="Broker Mobile" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Mobile")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Broker Email" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Email")%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="View" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgView" runat="server" CommandArgument='<%#Eval("contact_id") %>' ToolTip="Click to edit or view this Broker " CommandName="editadmin" ImageUrl="~/Admin/images/view-img.png" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
