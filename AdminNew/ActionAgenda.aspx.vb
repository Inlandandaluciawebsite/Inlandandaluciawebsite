...
Public Class Admin_ActionAgenda
    ...
    Public Sub BindAction(type As String)
        ...
        If type = "Buyer" Then
            ...
            Dim dt As DataTable
            If Convert.ToInt32(Session("AdminUser")) = 0 Then
                dt = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "USP_BUYER_FUTURE_SELECT_All_By_Partner_Id", sql).Tables(0)
            Else
    ...
    Protected Sub grdBuyerActionAgenda_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "EditBuyer" Then
            Response.Redirect("ActionAgenda.aspx?History_ID=" + e.CommandArgument.ToString() + "&Type=Buyer")
        End If
    End Sub
    Protected Sub btnClientHistoryUpdate_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("ActionAgenda.aspx?Type=" + drpActionAgendaType.SelectedValue)
    End Sub
    ...
    Protected Sub grdFranchiseActionAgenda_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "EditFranchise" Then
            Response.Redirect("ActionAgenda.aspx?History_ID=" + e.CommandArgument.ToString() + "&Type=Franchise")
        End If
    End Sub
End Class
