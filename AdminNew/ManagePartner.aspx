<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ManagePartner.aspx.vb" Inherits="ManagePartner" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">Manage Partner </div>
                                    ...
                                    <tr role="row" style="border: 1px solid #ddd">
                                        <asp:GridView ID="grdAdmin" DataKeyNames="contact_id" OnRowDataBound="grdAdmin_RowDataBound1" AllowPaging="true" PageSize="10" Font-Names="Open Sans, sans-serif" class="sorting" HeaderStyle-Height="20px" BorderColor="#dddddd" OnRowCommand="grdAdmin_RowCommand" OnPageIndexChanging="grdAdmin_PageIndexChanging" TabIndex="0" runat="server" AutoGenerateColumns="false" Width="100%">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Partner Name" HeaderStyle-Width="219px" HeaderStyle-Height="20px">
                                                    <ItemTemplate>
                                                        <%#Eval("contact_name") %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                              
                                                <asp:TemplateField HeaderText="Partner Mobile" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Mobile")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Partner Email" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <%#Eval("Contact_Email")%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="View" HeaderStyle-Width="219px">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgView" runat="server" CommandArgument='<%#Eval("contact_id") %>' ToolTip="Click to edit or view this Partner " CommandName="editadmin" ImageUrl="~/Admin/images/view-img.png" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
