...
Partial Class BuyerSource
    ...
    Protected Sub GridViewResults_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewResults.SelectedIndexChanged
        ...
        If 6 = ClassDataAccess.E_SystemVariable.Type Then
    ...
    Protected Sub ButtonDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
        ...
        Else
            ...
            GridViewPropertiesAffected.DataSource = CDataAccess.PropertiesUsingSystemVariable(6, Convert.ToInt32(Session("AdminSystemID")), Convert.ToInt32(Session("ContactPartnerID")))
            ...
            Else
                ...
                CDataAccess.RemoveSystemVariable(6, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            ' Save Entity
            CDataAccess.SaveSystemVariable(6, alEntries, Convert.ToInt32(Session("AdminSystemID")), TextBoxCode.Text.Trim.ToUpper)
    ...
    Private Sub DisplayEditFields()
        ...
        TableRowCode.Visible = (6 = ClassDataAccess.E_SystemVariable.Type)
        ButtonDelete.Visible = (6 <> ClassDataAccess.E_SystemVariable.Language)
