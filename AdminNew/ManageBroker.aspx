<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ManageBroker.aspx.vb" Inherits="ManageBrokers" %>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Broker Email" HeaderStyle-Width="219px">
                                                         ...
                                                         <asp:TemplateField HeaderText="Partners" HeaderStyle-Width="219px">
                                                            <ItemTemplate>
                                                                <%# AllPartners_By_MobileNumber(Eval("Contact_Mobile"))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
