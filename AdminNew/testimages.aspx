<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="testimages.aspx.vb" Inherits="Admin_testimages" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/ControlsNew/WebUserControlAdminLocation.ascx" TagName="AdminLocation" TagPrefix="ucAdminLocation" %>
<%@ Register Src="~/ControlsNew/WebUserControlAdminPropertyImage.ascx" TagName="AdminPropertyImage" TagPrefix="ucAdminPropertyImage" %>
    ...
    <asp:Table ID="TableGeneral" runat="server" Width="80%">
        ...
        <asp:TableRow Visible="false" >
            ...
            <asp:TableCell>
                ...
                &nbsp; <asp:Button ID="LinkButtonSTBrokerAdd" runat="server" Text="Add" OnClientClick="javascript:document.getElementById('AdminNavigation_LinkButtonSTBrokerAdd').click(); return false;" CssClass="default-button"  style="display:none"/>
    ...
    <asp:Table ID="TableDocuments" runat="server" Font-Names="Calibri" Visible="false">
        ...
        <asp:TableRow ID="TableRowUpdate" runat="server" Visible="false">
         ...
         <%-- <asp:TableRow ID="TableRowMove" runat="server" Visible="false">
            <asp:TableCell ColumnSpan="2" HorizontalAlign="Right">
                <asp:Label ID="Label1" runat="server" Text="Select Desitnation Directory"></asp:Label>
                <asp:HiddenField ID="hdsource" runat="server"  Value="0"/>
                  <asp:Label ID="lblsourcefile" runat="server"></asp:Label>
            </asp:TableCell>
         </asp:TableRow> --%>
          <asp:TableRow ID="TableRowMove" runat="server" Visible="false">
