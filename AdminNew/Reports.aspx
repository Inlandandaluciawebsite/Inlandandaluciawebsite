<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="Reports.aspx.vb" Inherits="ClientTours" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        #uniform-ContentPlaceHolder1_chkVirtualTour
        {
            float:left;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelAdminClientTour" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:UpdateProgress runat="server" ID="PageUpdateProgress" AssociatedUpdatePanelID="UpdatePanelAdminClientTour"
                DisplayAfter="1">
                <ProgressTemplate>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">Client Tour Search </div>
                            <div align="right">
                        ...
                        <div class="portlet-body">
                            <div class="form-body">
                                <div class="table-responsive">
                                    <asp:Table ID="TableTourHeader" runat="server" Width="100%" CssClass="table">
                    ...
                    Number of Properties
                                    ...
                                    Toured With
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:CheckBox ID="chkVirtualTour" runat="server" style="float:left;" Text="Virtual Tour" />
                                            </asp:TableCell>
                   ...
                   Partner Ref.
                    ...
                    Price
                                                ...
                                                <asp:TableCell Width="108px" HorizontalAlign="Center">
                    Time
                                                </asp:TableCell>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <asp:Table ID="TableOptions" runat="server" Width="100%">
                                            <asp:TableRow>
                                                <asp:TableCell Width="70%" style="text-align:right;">
                                                    <asp:Label ID="lblMessage" runat="server" Visible="false"></asp:Label>
                                                </asp:TableCell>
                                                <asp:TableCell Width="10%" HorizontalAlign="Right">
                                                    <asp:Button ID="ButtonFeedback" runat="server" Text="Feedback" Visible="false" CssClass="btn green" />
                                                </asp:TableCell>
                                                <asp:TableCell Width="10%" HorizontalAlign="Right">
                                                    <asp:Button ID="btnCreateNewTour" Text="Create New Tour" runat="server" Visible="false" OnClick="btnCreateNewTour_Click"
                                                        CssClass="btn green" />
                                                </asp:TableCell>
                                                <asp:TableCell Width="10%" HorizontalAlign="Right">
                                                ...
                                                <asp:TableCell Width="10%" HorizontalAlign="Right">
                                                    <asp:Button ID="ButtonPrint" Text="Print" runat="server" Visible="false" OnClientClick="return redirectToPage('ClientTour.aspx');" CssClass="btn green" />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                            ...
                                            <asp:TableRow ID="TableRowSaved" runat="server" Visible="false">
                                                ...
                                                <asp:TableCell ColumnSpan="3" HorizontalAlign="Right">
                                                    <strong>
                                                        <asp:Label ID="LabelTourSaved" runat="server" Text="The Client Tour has been successfully Saved"></asp:Label></strong>
                                                </asp:TableCell>
