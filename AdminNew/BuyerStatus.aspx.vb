...
Partial Class systemvariable
    ...
    Protected Sub GridViewResults_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewResults.SelectedIndexChanged
        ...
        If 2 = ClassDataAccess.E_SystemVariable.Type Then
    ...
    Protected Sub ButtonDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
        ...
        Else
            ...
            GridViewPropertiesAffected.DataSource = CDataAccess.PropertiesUsingSystemVariable(2, Convert.ToInt32(Session("AdminSystemID")), Convert.ToInt32(Session("ContactPartnerID")))
            ...
            Else
                ...
                CDataAccess.RemoveSystemVariable(2, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            ' Save Entity
            CDataAccess.SaveSystemVariable(2, alEntries, Convert.ToInt32(Session("AdminSystemID")), TextBoxCode.Text.Trim.ToUpper)
    ...
    Private Sub DisplayEditFields()
        ...
        TableRowCode.Visible = (2 = ClassDataAccess.E_SystemVariable.Type)
        ButtonDelete.Visible = (2 <> ClassDataAccess.E_SystemVariable.Language)
