...
Partial Class Admin_AddVendor
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs)
        ...
        sql(10) = New SqlParameter("@Contact_Partner_ID", Convert.ToInt32(drpbroker.SelectedValue))
        sql(11) = New SqlParameter("@Contact_Archived", chkArchived.Checked)
        SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "Usp_CONTACT_Insert_Vender", sql).ToString()
    ...
    Protected Sub btnimageprop_Click(sender As Object, e As EventArgs)
        Response.Redirect("AddProperty.aspx?VendorId=" + hdnvenid.Value)
    End Sub
End Class
