...
Partial Class AddUser
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs)
        ...
        sql(2) = New SqlParameter("@Contact_Registration_Number", "")
        ...
        sql(14) = New SqlParameter("@Contact_Commission", "")
        sql(15) = New SqlParameter("@Contact_Admin", False)
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs)
        ...
        sql(15) = New SqlParameter("@Contact_Commission", "")
        sql(16) = New SqlParameter("@Contact_Admin", False)
