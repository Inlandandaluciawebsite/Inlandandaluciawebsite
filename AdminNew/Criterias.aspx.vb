...
Partial Class Criterias
    ...
    Public Sub InitForm()
        ...
        LabelTitle.Text = "Criterias"
        GridViewResults.DataSource = CDataAccess.BuyerCriterias
    ...
    Protected Sub ButtonDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
        ...
        Else
            ...
            GridViewPropertiesAffected.DataSource = CDataAccess.PropertiesUsingSystemVariable(10, Convert.ToInt32(Session("AdminSystemID")), Convert.ToInt32(Session("ContactPartnerID")))
            ...
            Else
                ...
                CDataAccess.RemoveSystemVariable(10, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            ' Save Entity
            CDataAccess.SaveSystemVariable(10, alEntries, Convert.ToInt32(Session("AdminSystemID")), TextBoxCode.Text.Trim.ToUpper)
    ...
    Private Sub DisplayEditFields()
        ...
        TableRowCode.Visible = (3 = ClassDataAccess.E_SystemVariable.Type)
        ButtonDelete.Visible = (3 <> ClassDataAccess.E_SystemVariable.Language)
