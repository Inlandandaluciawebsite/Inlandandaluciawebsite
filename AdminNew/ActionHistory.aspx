<%@ Page Title="Action Agenda" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ActionHistory.aspx.vb" Inherits="ActionHistory" ValidateRequest="false" %>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer" style="border: 1px solid #ddd" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                                <thead>
                                                    <tr>
                                                        <td>
                                                            <b style="font-size: 20px;">ACTION AGENDA</b>
                                                        </td>
                                                    </tr>
