...
Partial Class WebUserControlAdminProperty
    ...
    Public Sub InitData(ByVal CProperty As ClassProperty)
        ...
        If Session("AdminPropertyBulkImageUpload") Is Nothing Then
            If Convert.ToInt32(Session("ContactPartnerID")) <> 3864 And Convert.ToInt32(Session("ContactPartnerID")) <> 3873 And Convert.ToInt32(Session("ContactPartnerID")) = CProperty.PartnerID Then
                tblpropref.Visible = False
            ...
            If (CProperty.PartnerID = Convert.ToInt16(Session("ContactPartnerID"))) Or Convert.ToBoolean(Session("AdminUser")) Then
            ...
            txtTAXABLEval.Text = CProperty.Taxablevalue.Trim
            ...
            chkIsIssue.Checked = CProperty.IsIssue
            txtpropref.Text = CProperty.CAReference
            ...
            If CProperty.Reference.Trim <> String.Empty Then
                ...
                For nImage As Integer = 1 To CProperty.NumberOfImages
                    ...
                    ' If this Image Exists Or DirectCast(Session("AdminUser"), Boolean)
        ...
        If Not bUpdating Then
            ...
            If Not TreeViewBrowser.SelectedNode Is Nothing Then
                ...
                If Not Convert.ToBoolean(Session("PropertyAdminReadOnly")) Then
                    ...
                    btnMove.Enabled = bDirectory Or bFile Or bRoot
    ...
    End Function
    Protected Sub ButtonViewBuyer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonViewBuyer.Click
        ...
        Dim CDataAccess As New ClassDataAccess
        CBuyer.Load(Convert.ToInt32(DropDownListBuyer.SelectedValue))
        CDataAccess = Nothing
    ...
    Private Function PopulateSaveDataGeneral(ByRef CProperty As ClassProperty) As Boolean
        ...
        CProperty.CAReference = txtpropref.Text
        ...
        Else
            ...
            Else
                ...
                If Not bError Then
                    ...
                    End If
                    If chkIsIssue.Checked = True Then
    ...
    Protected Sub chkIsIssue_CheckedChanged(sender As Object, e As EventArgs)
        ButtonSave.BackColor = Drawing.Color.Red
        ButtonSave.ForeColor = Drawing.Color.White
        ButtonSave.Font.Bold = True
    End Sub
    Protected Sub btnedirref_Click(sender As Object, e As EventArgs) Handles btnedirref.Click
    ...
    Protected Sub btnvack_Click(sender As Object, e As EventArgs) Handles btnvack.Click
