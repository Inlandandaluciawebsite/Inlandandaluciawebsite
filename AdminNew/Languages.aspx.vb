...
Partial Class BuyerSource
    ...
    Public Sub InitForm()
        ...
        For Each gvr As GridViewRow In GridViewResults.Rows
            ...
            gvr.Cells(7).Text = gvr.Cells(7).Text.Replace("''", "'").Trim
    ...
    Protected Sub GridViewResults_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewResults.SelectedIndexChanged
        ...
        TextBoxCode.Text = HttpUtility.HtmlDecode(RemoveAutoTranslate(GridViewResults.SelectedRow.Cells(7).Text.Trim))
        ' If this is Property Type or Country
        If 4 = ClassDataAccess.E_SystemVariable.Type Then
    ...
    Protected Sub ButtonDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
        ...
        Else
            ...
            GridViewPropertiesAffected.DataSource = CDataAccess.PropertiesUsingSystemVariable(4, Convert.ToInt32(Session("AdminSystemID")), Convert.ToInt32(Session("ContactPartnerID")))
            ...
            Else
                ...
                CDataAccess.RemoveSystemVariable(4, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            alEntries.Add(TextBoxCode.Text.Replace("'", "''").Trim)
            ' Save Entity
            CDataAccess.SaveSystemVariablelang(4, alEntries, Convert.ToInt32(Session("AdminSystemID")))
    ...
    Private Sub DisplayEditFields()
        ...
        TableRowCode.Visible = True '(4 = ClassDataAccess.E_SystemVariable.Type)
        ButtonDelete.Visible = True ' (4 <> ClassDataAccess.E_SystemVariable.Language)
