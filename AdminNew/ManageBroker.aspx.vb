...
Partial Class ManageBrokers
    ...
    Private Sub bindadmin()
        ...
        End If
    End Sub
    Public Function AllPartners_By_MobileNumber(ByVal MobileNumber As String) As String
        Dim sqlbrokerpartners As SqlParameter() = New SqlParameter(2) {}
        sqlbrokerpartners(0) = New SqlParameter("@Contact_Mobile", MobileNumber)
        sqlbrokerpartners(1) = New SqlParameter("@Contact_Type_Id", 6)
        Dim dt As DataTable = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "USP_Get_CommaSeperatedPartners_By_MobileNumber", sqlbrokerpartners).Tables(0)
        If dt.Rows.Count > 0 Then
