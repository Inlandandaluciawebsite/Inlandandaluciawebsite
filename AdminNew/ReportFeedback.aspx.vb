...
Partial Class ReportFeedback
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            DropDownListViewDateMonth.SelectedIndex = dateTomorrow.Month
    ...
    Public Sub LoadTour()
        ...
        ' If (Convert.ToDateTime(CClientTour.ViewingDate.Date) < System.DateTime.Now.Date) Then
        'DropDownListTouredWith.Enabled = False
        'DropDownListViewDateDay.Enabled = False
    ...
    Protected Sub ButtonFeedback_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonFeedback.Click
        ...
        Session("AdminCreateTourBuyerID") = Convert.ToInt32(DropDownListBuyer.SelectedItem.Value)
