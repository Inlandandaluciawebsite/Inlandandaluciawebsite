...
Partial Class Admin_LatestProperties
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Not Request.QueryString("Id") Is Nothing Then
                ButtonSearch_Click(ButtonSearch, Nothing)
                DropDownListDuration.SelectedIndex = Request.QueryString("Duration")
                CheckBoxCreated.Checked = Request.QueryString("Created")
                CheckBoxModified.Checked = Request.QueryString("Modified")
            End If
        End If
    End Sub

    Protected Sub GridViewResultslatest_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridViewResultslatest.SelectedIndexChanged
        ...
        CProperty.Load(Convert.ToInt32(GridViewResultslatest.SelectedRow.Cells(1).Text.Trim))
        CDataAccess = Nothing


        ' Assign to Session Variable
        ' Session("AdminPropertySelected") = CProperty
        Response.Redirect("AddProperty.aspx?PropertyId=" + GridViewResultslatest.SelectedRow.Cells(1).Text.Trim + "&Duration=" + Convert.ToString(DropDownListDuration.SelectedIndex) + "&Created=" + CheckBoxCreated.Checked.ToString() + "&Modified=" + CheckBoxModified.Checked.ToString())
        ' Raise Event
        'RaiseEvent PropertySelected()

    End Sub

    Protected Sub GridViewResultslatest_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles GridViewResultslatest.Sorting
    ...
    Private Sub ApplySorting()
        ...
        If Not Session("PropertyAdminPropertyLatestSortField") = String.Empty Then
            ...
            If Session("PropertyAdminPropertyLatestSortField").ToString.Trim = "Created" Then

                ' Price
                szSortBy = "CreateDateForSorting"
            ...
            End If
            If Session("PropertyAdminPropertyLatestSortField").ToString.Trim = "LastHistory" Then

                ' Price
                szSortBy = "LastHistoryDate"
            ...
            If Session("PropertyAdminPropertyLatestSortField").ToString.Trim = "LastModified" Then

                ' Price
                szSortBy = "ModifiedDateForSorting"
        ...
        GridViewResultslatest.DataSource = dvDataView

        ' Bind
        GridViewResultslatest.DataBind()
    ...
    Private Sub ApplyStyling()
        ...
        ' Hide the ID & Price
        If Not GridViewResultslatest.HeaderRow Is Nothing Then
            GridViewResultslatest.HeaderRow.Cells(1).Visible = False
            GridViewResultslatest.HeaderRow.Cells(2).Visible = False
            GridViewResultslatest.HeaderRow.Cells(5).Visible = False
            GridViewResultslatest.HeaderRow.Cells(19).Visible = False
            GridViewResultslatest.HeaderRow.Cells(20).Visible = False
            GridViewResultslatest.HeaderRow.Cells(21).Visible = False
            For Each gvr As GridViewRow In GridViewResultslatest.Rows
                gvr.Cells(1).Visible = False
                gvr.Cells(2).Visible = False
                gvr.Cells(5).Visible = False
                gvr.Cells(19).Visible = False
                gvr.Cells(20).Visible = False
                gvr.Cells(21).Visible = False
            Next
        End If
        ...
        ' Update Row Count
        LabelNoOfResults.Text = GridViewResultslatest.Rows.Count.ToString.Trim & " Result(s)"

        ' Set Visibility
        TableRowNoResults.Visible = GridViewResultslatest.Rows.Count < 1
    ...
    Public Sub Reload()
        ...
        GridViewResultslatest.Visible = GridViewResultslatest.Rows.Count > 0

    End Sub

    Protected Sub ButtonSearch_Click(sender As Object, e As EventArgs) Handles ButtonSearch.Click

        Dim isCreated As Int16 = 0
        Dim isModified As Int16 = 0
        If CheckBoxCreated.Checked Then
            isCreated = 1
        End If
        If CheckBoxModified.Checked Then
            isModified = 1
        End If
        ...
        Else
            ...
            If CheckBoxCreated.Checked Or CheckBoxModified.Checked Then
                ...
                If CheckBoxCreated.Checked And Not CheckBoxModified.Checked Then
                    ...
                    ' Created Only
                    dtDataTable = CDataAccess.LatestProperties(isCreated, isModified, dteFrom)
                ...
                Else
                    ...
                    dtDataTable = CDataAccess.LatestProperties(isCreated, isModified, dteFrom, dteFrom)
    ...
    Protected Sub GridViewResultslatest_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ' determine the value of the UnitsInStock field
            Dim lsDataKeyValue As String = GridViewResultslatest.DataKeys(e.Row.RowIndex).Values(0).ToString()
            ...
            End If
            If DataBinder.Eval(e.Row.DataItem, "IsIssue") = "Red" Then
                e.Row.BackColor = System.Drawing.Color.Red
            Else
                e.Row.BackColor = System.Drawing.Color.White
            End If

            If DataBinder.Eval(e.Row.DataItem, "Excl") = "Yes" Then
                Dim tcell As TableCell
                tcell = e.Row.Cells(14)
                tcell.Text = "<img src='images/star.png' width='30px' height='30px'></img>"
            Else
                e.Row.BackColor = System.Drawing.Color.White
                Dim tcell As TableCell
                tcell = e.Row.Cells(14)
