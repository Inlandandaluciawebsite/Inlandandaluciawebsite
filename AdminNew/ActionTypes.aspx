<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ActionTypes.aspx.vb" Inherits="ActionTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="upAddAdmin" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title"><%--Buyer Status--%>
            </h3>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <div class="form-body">
                                        <h3>System Parameters:
                                            <asp:Label ID="LabelTitle" runat="server"></asp:Label></h3>
                                            ...
                                            <div class="row" id="TableRowAddEditEnglish" runat="server" visible="false">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="TextBoxEnglish" runat="server" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <asp:Button ID="ButtonAutoTranslate" runat="server" Text="Auto Translate" CssClass="btn green" />
                                                        </div>
