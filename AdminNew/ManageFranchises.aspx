<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="ManageFranchises.aspx.vb" Inherits="ManageFranchises" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">Manage Franchises </div>
                                            ...
                                            <tr role="row" style="border: 1px solid #ddd">
                                                <asp:GridView ID="grdAdmin" DataKeyNames="contact_id" OnRowDataBound="grdAdmin_RowDataBound1" AllowPaging="true" PageSize="10" Font-Names="Open Sans, sans-serif" class="sorting" HeaderStyle-Height="20px" BorderColor="#dddddd" OnRowCommand="grdAdmin_RowCommand" OnPageIndexChanging="grdAdmin_PageIndexChanging" TabIndex="0" runat="server" AutoGenerateColumns="false" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Franchise Name" HeaderStyle-Width="219px" HeaderStyle-Height="20px">
                                                            <ItemTemplate>
                                                                <%#Eval("contact_name") %>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Franchise Mobile" HeaderStyle-Width="219px">
                                                            <ItemTemplate>
                                                                <%#Eval("Contact_Mobile")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Franchise Email" HeaderStyle-Width="219px">
                                                            <ItemTemplate>
                                                                <%#Eval("Contact_Email")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
