<%@ Page Title="" Language="VB" MasterPageFile="~/AdminNew/Admin.master" AutoEventWireup="false" CodeFile="AddUser.aspx.vb" Inherits="AddUser" %>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <%--<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <asp:DropDownList ID="drppartner" runat="server" OnSelectedIndexChanged="drppartner_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-6" id="TableRowImage" runat="server" visible="false">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9" style="padding-left:30px;">
                                               <b>If you are going to create an Admin user please select  one Partner only</b>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">&nbsp</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" id="TableRowImageUpload" runat="server" visible="false">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" id="TableRowAdmin" runat="server" visible="false">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"></label>
                                                    <div class="col-md-9">
