...
Public Class BuyerActionAgenda
    ...
    Public Sub BindbuyerAction()
        ...
        Dim dt As DataTable = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("IA").ConnectionString, CommandType.StoredProcedure, "USP_BUYER_FUTURE_SELECT", sql).Tables(0)
        If dt.Rows.Count > 0 Then
