...
Partial Class propsearch
    ...
    Private Property DataAccess() As ClassDataAccess
        ...
        End Set
    End Property
    Public Latitude As Double, Longitude As Double, Reference As String
    Private PageSize As Integer = 10

    ' Private pageIndex = 1
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Session("propertyref") = Request.QueryString("propertyref")
        ' Local Vars
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        ...
        If Bathrooms = "" Then
            Bathrooms = 0
        End If
        Response.Redirect("propsearch.aspx?page=1&RegionId=" + region + "&AreaId=" + area + "&SubAreaId=0" + "&typeId=" + listtype + "&minimumbedroom=" + bedrooms + "&minimumbathroom=" + Bathrooms + "&minimumprice=" + minprice + "&maximumprice=" + maxprice)
    ...
    Private Sub Showproperybyparam(pageIndex As Integer)
        ...
        Dim dt As DataTable = SqlHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings("con").ConnectionString, CommandType.StoredProcedure, "Usp_Property_SearchBy_Param01", sql).Tables(0)
        If dt.Rows.Count > 0 Then
