<%@ Page Title="" Language="VB" MasterPageFile="~/InlandandAlucia.master" AutoEventWireup="false" CodeFile="cosa_reguelo.aspx.vb" Inherits="cosa_reguelo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-12">
                <%--<img src="/images/photos/BandB/FULL INDIVIDUAL PAGE EL REGUELO_Mesa de trabajo 1_Mesa de trabajo 1.png" alt="Featured 1" />--%>
                <img src="/images/photos/BandB/FULL INDIVIDUAL3.png" width="750" height="1500" alt="Featured 1" />
            </div>
        </div>
