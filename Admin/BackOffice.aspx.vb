...
Public Class BackOffice
        ...
        Else
            ...
            If Not Session("AdminActiveControl") Is Nothing Then
                ...
                Select Case Session("AdminActiveControl").GetType
                    ...
                    Case GetType(ASP.controls_webusercontrolsalespersontours_ascx)
                        CreateSalespersontour()
                    Case GetType(ASP.controls_webusercontrolnovideos_ascx)
                        CreateNovideos()
                    Case GetType(ASP.controls_webusercontrolactionagenda_ascx)
                        CreateActionAgenda()
                End Select
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'Active user control according to query string value

            If Not String.IsNullOrEmpty(Request.QueryString("Type")) Then
                'Session("AdminPropertySelected") = Request.QueryString("Property_Ref")
                'CreateProperty()
                ...
                CProperty.Load(Request.QueryString("Property_Ref"))
                CDataAccess = Nothing
    ...
    End Sub
    Private Sub CreateSalespersontour()

        ' Create a New Control
        UpdatePanelMain.ContentTemplateContainer.Controls.Clear()

        Dim ctrl As ASP.controls_webusercontrolsalespersontours_ascx = CType(LoadControl("~/Controls/WebUserControlSalespersonTours.ascx"), ASP.controls_webusercontrolsalespersontours_ascx)

        ' Define an ID
        ctrl.ID = "AdminSalesperontour"
    ...
    End Sub
    Protected Sub AdminNavigation_salesclient() Handles AdminNavigation.salesclient
    ...
    End Sub
    Private Sub CreateNovideos()

        ' Create a New Control
        UpdatePanelMain.ContentTemplateContainer.Controls.Clear()

        Dim ctrl As ASP.controls_webusercontrolnovideos_ascx = CType(LoadControl("~/Controls/WebUserControlNoVideos.ascx"), ASP.controls_webusercontrolnovideos_ascx)

        ' Define an ID
        ctrl.ID = "AdminNovideos"
    ...
    End Sub
    Protected Sub AdminNavigation_Novideos() Handles AdminNavigation.Novideos
    ...
    Private Sub CreateActionAgenda()

        ' Create a New Control
        UpdatePanelMain.ContentTemplateContainer.Controls.Clear()

        Dim ctrl As ASP.controls_webusercontrolactionagenda_ascx = CType(LoadControl("~/Controls/WebUserControlActionAgenda.ascx"), ASP.controls_webusercontrolactionagenda_ascx)

        ' Define an ID
        ctrl.ID = "AdminActionAgenda"
    ...
    End Sub
    Protected Sub AdminNavigation_ActionAgenda() Handles AdminNavigation.ActionAgenda
